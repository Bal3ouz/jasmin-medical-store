export const CATEGORY_SEED = [
  {
    ...
    slug: "cosmetique",
    name: "Cosmétique",
    description: "Soins du visage, du corps et des cheveux.",
    parentId: null,
    displayOrder: 1,
  },
  {
    ...
    slug: "orthopedie",
    name: "Orthopédie",
    description: "Maintien, soutien et confort articulaire.",
    parentId: null,
    displayOrder: 2,
  },
  {
    ...
    description: "Tension, diabète, aérosols, mobilité.",
    parentId: null,
    displayOrder: 3,
  },
  {
    ...
    description: "Hygiène, premiers soins, compléments.",
    parentId: null,
    displayOrder: 4,
  },
...

  {
    ...
    slug: "lombaire",
    name: "Soutien lombaire",
    parentId: "c0000000-0000-4000-8000-000000000002",
    description: "Ceintures et orthèses lombaires.",
    displayOrder: 1,
  },
  {
    ...
    name: "Genou",
    parentId: "c0000000-0000-4000-8000-000000000002",
    description: "Genouillères et orthèses.",
    displayOrder: 2,
  },
  {
    ...
    name: "Cheville",
    parentId: "c0000000-0000-4000-8000-000000000002",
    description: "Chevillères.",
    displayOrder: 3,
  },
  {
    id: "c0000000-0000-4000-8000-000000000024",
    slug: "aides-marche",
    name: "Aides à la marche",
    parentId: "c0000000-0000-4000-8000-000000000002",
    description: "Cannes, béquilles, déambulateurs.",
    displayOrder: 4,
  },

  {
    ...
    description: "Tensiomètres et accessoires.",
    displayOrder: 1,
  },
  {
    ...
    name: "Diabète",
    parentId: "c0000000-0000-4000-8000-000000000003",
    description: "Lecteurs et bandelettes.",
    displayOrder: 2,
  },
  {
    id: "c0000000-0000-4000-8000-000000000033",
    slug: "aerosol",
    name: "Aérosolthérapie",
    parentId: "c0000000-0000-4000-8000-000000000003",
    description: "Aérosols et nébuliseurs.",
    displayOrder: 3,
  },
  {
    ...
    parentId: "c0000000-0000-4000-8000-000000000003",
    description: "Mobilité et autonomie.",
    displayOrder: 4,
  },

  {
    ...
    description: "Soins bébé et puériculture.",
    displayOrder: 1,
  },
  {
    ...
    name: "Premiers soins",
    parentId: "c0000000-0000-4000-8000-000000000004",
    description: "Pansements, antiseptiques.",
    displayOrder: 2,
  },
  {
    ...
    parentId: "c0000000-0000-4000-8000-000000000004",
    description: "Vitamines, énergie, sommeil.",
    displayOrder: 3,
  },
];
