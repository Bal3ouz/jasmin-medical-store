    ...
    <main>
      <AiryContainer className="px-6 py-20 lg:px-12">
        <article className="mx-auto max-w-3xl space-y-6">
          ...
          <BodyText>
            Les présentes CGV régissent les ventes effectuées sur jasmin-medical-store.com par
            Jasmin Médical Store auprès de ses clients particuliers.
          </BodyText>
          <H2Section className="text-2xl">2. Prix et paiement</H2Section>
          <BodyText>
            Les prix sont en dinars tunisiens (TND), TTC. Le paiement s'effectue à la livraison
            (cash on delivery) sauf indication contraire au moment de la commande.
          </BodyText>
